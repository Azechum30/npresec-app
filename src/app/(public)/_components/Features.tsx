...
const learningAreas = [
  {
    ...
    bgColor: "bg-primary/10 dark:bg-card",
  },
  {
    icon: Utensils,
    name: "Home Economics",
...
export const Features = () => {
  ...
  const [__, setHoveredArea] = useState<number | null>(null);
  ...
  return (
    <div
      ref={container}
      className="w-full bg-linear-to-b from-secondary/50 to-background py-8 md:py-24 px-4 md:px-6 lg:px-16 relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-96 h-96 bg-linear-to-r from-pink-500/3 to-blue-500/3 rounded-full blur-3xl" />
      </div>
      ...
      <PublicMainContainer className="features-container relative bg-background/80 backdrop-blur-sm rounded-3xl border border-border/50 shadow-2xl p-8 md:p-12">
        ...
        <div className="text-center mb-16">
          <div className="features-badge inline-flex items-center gap-2 px-6 py-3 bg-linear-to-r from-primary/10 to-secondary/10 rounded-full border border-primary/20 mb-8">
            <Sparkles className="w-5 h-5 text-primary" />
            <span className="text-sm font-semibold text-primary">@NPRESEC</span>
          </div>

          <h1 className="features-title text-3xl md:text-4xl lg:text-5xl font-bold bg-linear-to-r from-primary to-muted-foreground bg-clip-text text-transparent mb-4">
            Why Choose Us
          </h1>
        ...
        <div className="grid lg:grid-cols-3 gap-8 mb-20">
          {features.map((feature, index) => {
            ...
            return (
              ...
              <div
                key={index.toString()}
                className={`feature-card feature-card-${index} group relative p-8 rounded-2xl border border-border/50 bg-linear-to-br from-background to-card/20 hover:shadow-xl transition-all duration-500 cursor-pointer overflow-hidden`}
                ...
                {/* Icon container */}
                <div
                  className={`feature-icon relative z-10 w-16 h-16 mx-auto mb-6 rounded-full bg-linear-to-br ${feature.color} p-0.5`}>
                  <div className="w-full h-full rounded-full flex items-center justify-center">
                    <Icon className="w-8 h-8 text-foreground group-hover:text-card-foreground transition-colors duration-300" />
                  </div>
                </div>
        ...
        <div className="courses-section">
          <div className="text-center mb-12">
            <h2 className="text-2xl md:text-3xl font-bold text-primary mb-4 relative inline-block">
              Learning Areas
              <div className="absolute -bottom-2 left-1/2 transform -translate-x-1/2 w-16 h-1 bg-linear-to-r from-primary to-ring/55 rounded-full" />
            </h2>
              ...
              return (
                ...
                <div
                  ...
                  <div className="flex items-center gap-4">
                    <div
                      className={`p-3 rounded-lg ${area.color} bg-ring/10 transition-transform duration-300 group-hover:scale-110`}>
          ...
          <div className="cta-buttons relative flex flex-col sm:flex-row gap-4 w-fit mx-auto">
            <Link
              ...
              <div className="absolute inset-0 bg-linear-to-r from-primary/0 via-white/20 to-primary/0 translate-x-full group-hover:translate-x-full transition-transform duration-700" />
            </Link>
            ...
            <Link
              ...
              <div className="absolute inset-0 bg-linear-to-r from-destructive/0 via-white/20 to-destructive/0 translate-x-full group-hover:translate-x-full transition-transform duration-700" />
            </Link>
            ...
            <div className="absolute z-10 top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-linear-to-r from-primary/20 to-destructive/20 w-16 h-16 rounded-full blur-sm" />
          </div>
        </div>
      </PublicMainContainer>
    </div>
