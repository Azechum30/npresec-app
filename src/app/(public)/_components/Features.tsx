    ...
    <div
      ...
      <PublicMainContainer className="bg-background p-4 feature-container">
        ...
        <div className="grid lg:grid-cols-3 gap-6 px-2 py-10">
          <div className="flex flex-col items-center space-y-6 rounded-lg border p-4 feature">
            ...
            <p className="leading-loose">
              ...
              paired with a dedicated academic counselor or advisor who actively
              supports their growth. When challenges arise, tailored
              interventions are implemented to guide students back on track and
        ...
        <h1 className="text-2xl font-medium text-center relative pt-6 text-primary pb-4 after:absolute after:bottom-0 after:inset-0 after:z-0 after:mx-auto after:border-b-2 after:border-primary after:w-[52px] course-title">
          Learning Areas
        </h1>
        <div className="py-10 grid lg:grid-cols-3 px-2 gap-y-2 lg:place-items-center">
          <div className="flex flex-col gap-2 courses">
