...
const timelineEvents = [
  {
    ...
    icon: Building,
    color: "from-primary to-muted-foreground dark:to-accent",
  },
  {
    year: 1991,
    title: "ARB Closure",
...
export const AboutPageContent = () => {
  ...
  return (
    <div
      ref={container}
      className="min-h-screen bg-linear-to-b from-background to-card/20 border rounded-2xl shadow-2xl overflow-hidden">
      ...
      <PublicMainContainer className="relative z-10 py-16 md:py-24">
          ...
          <Card className="p-8 md:p-12 bg-background/80 backdrop-blur-sm border border-border/50 shadow-xl">
            <div className="max-w-4xl mx-auto">
              <div className="flex items-center gap-3 mb-8">
                ...
                <h2 className="text-3xl md:text-4xl font-bold bg-linear-to-r from-primary to-muted-foreground dark:to-accent bg-clip-text text-transparent">
                  Brief History
                </h2>
              </div>
                ...
                return (
                  <div
                    ...
                    <div className="absolute left-4 md:left-1/2 transform md:-translate-x-1/2 z-10">
                      <div
                        className={`w-12 h-12 bg-linear-to-br ${event.color} rounded-full flex items-center justify-center shadow-lg border-4 border-ring`}>
              ...
              return (
                <Card
                  ...
                  <CardContent className="p-0 text-center">
                    <div
                      className={`inline-flex p-4 rounded-2xl bg-linear-to-br from-ring/20 to-accent/30 mb-4 ${achievement.color}`}>
        ...
        <div className="cta-section text-center">
          <Card className="p-12 bg-linear-to-br from-primary/10 via-secondary/10 to-accent/10 border border-primary/20 shadow-xl">
            <CardContent className="p-0">
              <h3 className="text-3xl md:text-4xl font-bold mb-6 bg-linear-to-r from-primary to-muted-foreground dark:to-accent bg-clip-text text-transparent">
