...
export const VisionMissionContent = () => {
  ...
  return (
    <div ref={container} className="relative overflow-hidden">
      ...
      <div className="floating-decoration floating-element parallax-bg absolute top-1/2 -left-32 w-64 h-64 bg-linear-to-br from-accent/10 to-primary/10 rounded-full blur-3xl" />
      <div className="floating-decoration floating-element parallax-bg absolute bottom-0 right-1/4 w-32 h-32 bg-linear-to-br from-secondary/10 to-accent/10 rounded-full blur-2xl" />
      ...
      <div className="flex flex-col gap-16">
        ...
        {/* Vision Section */}
        <Card className="vision-section relative overflow-hidden bg-linear-to-br from-background/80 to-accent/30 backdrop-blur-xl border-border/50 shadow-2xl">
          {/* Decorative elements */}
          <div className="absolute -top-6 -right-6 w-24 h-24 bg-linear-to-br from-primary/10 to-secondary/10 rounded-full blur-xl" />
          ...
          <CardContent className="p-8 md:p-12">
            <div className="flex flex-col md:flex-row gap-8 items-start">
              ...
              <div className="shrink-0">
                <div className="w-20 h-20 bg-linear-to-br from-primary to-secondary rounded-2xl flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform duration-300">
              ...
              <div className="flex-1">
                <div className="flex items-center gap-3 mb-6">
                  <h2 className="text-3xl md:text-4xl font-bold bg-linear-to-r from-primary to-accent bg-clip-text text-transparent">
                    Our Vision
                  </h2>
                  <Sparkles className="w-6 h-6 text-primary" />
                </div>
                <div className="h-1 w-20 bg-linear-to-r from-primary to-secondary rounded-full mb-6" />
        ...
        {/* Mission Section */}
        <Card className="mission-section relative overflow-hidden bg-linear-to-br from-background/80 to-accent/30 backdrop-blur-xl border-border/50 shadow-2xl">
          {/* Decorative elements */}
          <div className="absolute -bottom-6 -left-6 w-32 h-32 bg-linear-to-br from-secondary/10 to-accent/10 rounded-full blur-xl" />
          ...
          <CardContent className="p-8 md:p-12">
            <div className="flex flex-col md:flex-row gap-8 items-start">
              ...
              <div className="flex-1 md:order-2">
                <div className="flex items-center gap-3 mb-6">
                  <h2 className="text-3xl md:text-4xl font-bold bg-linear-to-r from-secondary to-accent bg-clip-text text-transparent">
                    Our Mission
                  </h2>
                  <Sparkles className="w-6 h-6 text-secondary" />
                </div>
                <div className="h-1 w-20 bg-linear-to-r from-secondary to-accent rounded-full mb-6" />
                <p className="text-lg md:text-xl leading-relaxed text-foreground/80">
              ...
              <div className="shrink-0 md:order-1">
                <div className="w-20 h-20 bg-linear-to-br from-secondary to-accent rounded-2xl flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform duration-300">
        ...
        <div className="values-section">
          <div className="values-header text-center mb-12">
            ...
            <div className="h-1 w-24 bg-linear-to-r from-primary to-accent rounded-full mx-auto mb-6" />
            ...
            {coreValues.map((value, index) => {
              ...
              return (
                <Card
                  ...
                  {/* Decorative corner */}
                  <div className="absolute -top-2 -right-2 w-16 h-16 bg-linear-to-br from-primary/10 to-secondary/10 rounded-full blur-lg opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div
                        className={`
                          ...
                          ${
                            isHovered
                              ? `bg-linear-to-br ${value.gradient} text-white shadow-lg scale-110`
                              : `${value.bgColor} text-foreground/70`
                          }
                        `}>
