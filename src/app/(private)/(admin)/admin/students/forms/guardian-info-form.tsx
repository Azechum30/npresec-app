...
import { GuardianInfoSchema, type GuardianInfoType } from "@/lib/validation";
import { zodResolver } from "@hookform/resolvers/zod";
import { ChevronLeft, ChevronRight } from "lucide-react";
import { useEffect } from "react";
import { useForm } from "react-hook-form";
import { useCancelEditStudent } from "../hooks/use-cancel-edit-student";
import { useGuardianInfo, useStudentStore } from "../store";
...
export default function GuardianInfoForm() {
  ...
  const gurdianInfoData = useGuardianInfo();

  useEffect(() => {
    form.reset(gurdianInfoData);
  }, [form, gurdianInfoData]);
    ...
    <Form {...form}>
      <form
        ...
        <div className="border-b pb-3">
          <h1 className="text-lg font-semibold">Parent/Guardian Information</h1>
          <FormDescription>
