...
import { updateAttendance } from "@/app/(private)/admin/attendance/actions/mutations";
...
export const useUpdateSingleAttendance = () => {
	...
	const handleUpdateSingleAttendance = async(values: EditSingleStudentAttendanceType)=>{
