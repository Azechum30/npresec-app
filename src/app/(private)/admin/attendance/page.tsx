...
import { getAttendance, getSingleAttendance } from "@/app/(private)/admin/attendance/actions/queries";
import { getClassesAction } from "@/app/(private)/admin/classes/actions/server-actions";
import {
	SingleStudentAttendanceDialog
} from "@/app/(private)/admin/attendance/components/single-student-attendance-dialog";
...
export default async function AttendancePage() {
	...
	return <>
		...
		<Suspense
			fallback={<DataTableSkeleton columnCount={7} filterCount={2} cellWidths={[
			"10rem", "30rem", "10rem", "10rem", "6rem", "6rem", "6rem"
		]} shrinkZero  />
		}
		>
