...
import {DashboardData} from "@/app/(private)/admin/dashboard/actions/dashboard-data";
import {formatDistanceToNow} from "date-fns"
import Image from "next/image";

type ColumnsType = Pick<DashboardData, "recentStudents">["recentStudents"][number]
...
export const columns = [
    ...
    },
    {
        header: "Enrolled",
        cell: ({row}) => {
            const formattedDate = formatDistanceToNow(new Date(row.original.dateEnrolled), {
                addSuffix: true,
            })
