...
import {columns} from "@/app/(private)/admin/dashboard/components/DashboardColumns";
...
export default function DashboardContent({
	...
	const genderTotals = useMemo(()=>{
		return [data?.counts.studentMales as number ?? 0, data?.counts.studentFemales as number ?? 0].reduce((acc, cur)=> acc + cur, 0)
	},[data])
	...
	const genderData = [
		{name: "Males", value:data.counts.studentMales, fill: "hsl(var(--chart-5))" },
		{name: "Females", value:data.counts.studentFemales, fill: "hsl(var(--chart-1))" },
	]

	const yearGroupDistributionData = [
		{name: "Form 1", males: data.counts.yearGroupGender.yearOneMales, females: data.counts.yearGroupGender.yearOneFemales},
		{name: "Form 2", males: data.counts.yearGroupGender.yearTwoMales, females: data.counts.yearGroupGender.yearTwoFemales},
		{name: "Form 3", males: data.counts.yearGroupGender.yearThreeMales, females: data.counts.yearGroupGender.yearThreeFemales},
	]
		...
		<div className="space-y-6">
			...
			<div className="grid gap-4 md:grid-cols-2">
				...
				<Card>
					...
					<CardContent>
						<ChartContainer config={chartOptions} className="min-h-[200px] w-full">
				...
				<Card>
					...
					<CardFooter>
						<div className="flex w-full items-start gap-2 text-sm">
							<div className="grid gap-2">
								<div className="flex items-center gap-2 font-medium leading-none">
									Trending Gender for each year group <TrendingUp className="h-4 w-4" />
								</div>
								<div className="flex items-center gap-2 leading-none text-muted-foreground">
			...
			<Card className="overflow-auto">
				<CardHeader className="flex flex-row items-center justify-between space-y-0 pb-6">
					...
					<Link href="/admin/students">
						<Button size="sm" variant="outline" className="border-blue-300 text-blue-600 hover:bg-blue-50 dark:hover:bg-blue-400">
							View All
						</Button>
					</Link>
				</CardHeader>
