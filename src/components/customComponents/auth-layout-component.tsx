  ...
  return (
    <div
      ...
      <div className="auth-background fixed inset-0 z-0">
        ...
        <div
          className="parallax-bg absolute bottom-1/4 right-1/4 w-80 h-80 bg-linear-to-br from-secondary/15 to-accent/15 rounded-full blur-3xl animate-pulse"
          style={{ animationDelay: "1s" }}
        />
        <div
          className="parallax-bg absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-64 h-64 bg-linear-to-br from-accent/10 to-primary/10 rounded-full blur-2xl animate-pulse"
      ...
      {/* Floating decorations */}
      <div className="floating-auth-decoration floating-auth-element fixed top-20 right-20 w-16 h-16 bg-linear-to-br from-primary/20 to-secondary/20 rounded-full blur-lg pointer-events-none z-20" />
      <div className="floating-auth-decoration floating-auth-element fixed bottom-32 left-16 w-12 h-12 bg-linear-to-br from-accent/25 to-primary/25 rounded-full blur-md pointer-events-none z-20" />
      <div className="floating-auth-decoration floating-auth-element fixed top-1/2 right-1/3 w-8 h-8 bg-linear-to-br from-secondary/30 to-accent/30 rounded-full blur-sm pointer-events-none z-20" />
          ...
          <div className="w-full max-w-md space-y-8">
            ...
            <div className="auth-logo flex flex-col items-center space-y-4">
              <Link
                ...
                {/* Logo glow effect */}
                <div
                  className={`absolute inset-0 bg-linear-to-br from-primary/20 to-secondary/20 rounded-2xl blur-lg opacity-0 transition-opacity duration-300 ${
            ...
            <div className="auth-content">{siblings}</div>
            {/* Terms footer */}
