...
export default function CommandButton() {
  ...
  return (
    <Button
      ...
      onClick={onOpen}
      className={cn(
        "relative md:w-auto w-[300px] lg:w-[300px] py-2 flex items-center justify-between text-muted-foreground hover:text-inherit",
        open && "w-[230px] md:w-auto lg:w-[300px]"
      )}>
